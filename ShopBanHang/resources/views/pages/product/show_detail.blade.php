...
<div class="category-tab shop-details-tab"><!--category-tab-->
	...
	<div class="tab-content">
		<div class="tab-pane fade active in" id="details" >
			<p>{!!$value->product_desc!!}</p><!-- 2 dấu chấm than để ghi các kí tự đặc biệt-->
		</div>
	...
	<div id="recommended-item-carousel" class="carousel slide" data-ride="carousel">
		<div class="carousel-inner">
			<div class="item active">
				...
				<a href="{{URL::to('/chi-tiet-san-pham/'.$recomend->product_id)}}">
				<div class="col-sm-4">
					<div class="product-image-wrapper">
						<div class="single-products">
                			<div class="productinfo text-center">
                    			<img src="{{URL::to('public/upload/product/'.$recomend->product_image)}}" alt="" />
                    			<h2>{{number_format($recomend -> product_price).' '.'VNĐ'}}</h2>
                    			<p>{{$recomend->product_name}}</p>
